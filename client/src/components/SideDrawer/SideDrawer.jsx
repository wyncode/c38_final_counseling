...
import LogoIcon from './mind_passage_icon.svg';
  ...
  return (
    <div className="side-drawer">
      <Nav className="top-nav-items" defaultActiveKey="/" as="ul">
        ...
        <Nav.Item as="li">
          <Link to="/therapist-search" onClick={() => setOpen(!open)}>
            Find a Therapist
          </Link>
        </Nav.Item>

        <Nav.Item as="li">
          <Link to="/mental-hygiene" onClick={() => setOpen(!open)}>
            Mental Hygiene
          </Link>
        </Nav.Item>
